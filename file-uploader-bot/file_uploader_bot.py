...
# (headers, error strings, rendered file bodies, and .md files are rendered
# as raw unfenced text) — disable mention parsing so a filename or uploaded
# file body containing "@everyone" or "<@&ROLEID>" can't ping anyone.
